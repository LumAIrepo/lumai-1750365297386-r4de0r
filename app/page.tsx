    ...
    <div className={`min-h-screen bg-gradient-to-br from-purple-50 to-purple-100 ${inter.className}`}>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8 text-center">
            <div className="bg-purple-100 rounded-lg p-8">
              <div className="text-3xl font-bold text-purple-600 mb-2">400ms</div>
              <div className="text-purple-700">Block Time</div>
            </div>
            <div className="bg-purple-100 rounded-lg p-8">
              <div className="text-3xl font-bold text-purple-600 mb-2">65,000</div>
              <div className="text-purple-700">TPS Capacity</div>
            </div>
            <div className="bg-purple-100 rounded-lg p-8">
              <div className="text-3xl font-bold text-purple-600 mb-2">$0.00025</div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-purple-600 to-purple-800">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <button className="bg-green-400 text-purple-900 px-8 py-4 rounded-lg font-semibold hover:bg-green-300 transition-colors">
            Start Building Now
          </button>
        </div>
      </section>
